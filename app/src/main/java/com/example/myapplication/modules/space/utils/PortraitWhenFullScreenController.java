...
public class PortraitWhenFullScreenController extends StandardVideoController {
    ...
    protected void initView() {
        ...
        mFullScreen = vodControlView.findViewById(xyz.doikki.videocontroller.R.id.fullscreen);
...
//        adjustView();
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == xyz.doikki.videocontroller.R.id.fullscreen) {
            toggleFullScreen();
        } else if (i == xyz.doikki.videocontroller.R.id.lock) {
            mControlWrapper.toggleLockState();
        } else if (i == xyz.doikki.videocontroller.R.id.iv_play) {
            togglePlay();
        } else if (i == xyz.doikki.videocontroller.R.id.back) {
            stopFullScreen();
